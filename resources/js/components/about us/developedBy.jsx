    ...
    <DevelopersWrapper>
      <Developer animate={true} onClick={() => window.location.href='https://www.linkedin.com/in/mustapha-el-idrissi-308bb2268/'}>
        <DeveloperImageWrapper>
          <DeveloperImage src=".\img\appsbymuss.JPG" />
        </DeveloperImageWrapper>
      ...
      <Developer animate={true} onClick={() => window.location.href='https://www.linkedin.com/in/youssef-el-idrissi-574021250/'}>
        <DeveloperImageWrapper>
          <DeveloperImage src=".\img\youss.JPG" />
        </DeveloperImageWrapper>
        <DeveloperTitle animate={true}>{t('develop_youss')}</DeveloperTitle>
      <DeveloperDescription animate={true}>
        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
      </DeveloperDescription>
    </Developer>
